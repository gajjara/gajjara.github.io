...
**Summary:**
Due to the lack of charge potential within the piezoelectrics and peltier tiles, the battery in an XBox battery is charged by a very little amount of energy. However we were sucesfully able to prove that there is a potential for piezoelectrics and peltier tiles to be used in a game controller to charge itself, as were able to assemble the controller with the additional elements, and did not signfigantly affect user experience. 
